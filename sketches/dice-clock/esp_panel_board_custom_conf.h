/*
 * Custom board configuration for the Waveshare ESP32-S3-Touch-LCD-5.
 *
 * Reuses the library's official preset but disables the touch panel, which the
 * dice clock does not need.
 */
...
#include <board/supported/waveshare/BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_5.h>
